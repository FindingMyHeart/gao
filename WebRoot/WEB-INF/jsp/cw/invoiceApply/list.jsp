...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										{{# } }}
										<button type="button" class="btn bg-pink  btn-xs" lay-event="cancel" >作废</button>
										<button type="button" class="btn bg-orange btn-xs" lay-event="reject">退回</button>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/cw/invoiceApply/list.js"></script>
