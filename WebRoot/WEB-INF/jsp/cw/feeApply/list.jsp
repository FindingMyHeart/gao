...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5 col-sm-12">
							...
							<ul class="breadcrumb padding-0">
								...
								<li class="breadcrumb-item active">费用管理</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">费用申请</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										{{# } }}
										<button type="button" class="btn btn-info btn-xs" lay-event="detail" style="display:none;">预览</button>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/cw/feeApply/list.js"></script>
