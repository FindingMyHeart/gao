...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5 col-sm-12">
							...
							<ul class="breadcrumb padding-0">
								...
								<li class="breadcrumb-item active">其他采购</li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="card layListTable">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">采购申请</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="body">
								<div class="row clearfix">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="BUY_TYPE_SEARCH">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="APPLY_ID_SEARCH">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="申请日期" id="APPLY_DATE_SEARCH">
										</div>
									</div>
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										<button type="button" class="btn btn-warning btn-xs" lay-event="del">删除</button>
										<button type="button" class="btn btn-primary btn-xs" lay-event="submit">提交</button> 
										{{# } }}
		...
		<script type="text/javascript" src="static/js/modules/project/buy/other_buy_list.js"></script>
	</body>
