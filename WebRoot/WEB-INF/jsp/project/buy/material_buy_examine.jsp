...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
						...
						<div class="card layListTable">
							...
							<div class="body">
								<div class="row clearfix">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="采购人" type="text" id="BUY_NAME_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
		...
		<script type="text/javascript" src="static/js/modules/project/buy/material_buy_examine.js"></script>
	</body>
