...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
						...
						<div class="card layListTable">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">项目登记</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="body">
								<div class="row clearfix">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="PROJECT_STATUS_SEARCH">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="施工地点" type="text" id="CONSTRUCTION_ADRESS_SEARCH">
										</div>
									</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/project/base/examine.js"></script>
