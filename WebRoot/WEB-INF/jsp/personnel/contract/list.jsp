...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5 col-sm-12">
							...
							<ul class="breadcrumb padding-0">
								...
								<li class="breadcrumb-item active">人事合同管理</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">人事合同录入</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="合同开始日期" id="CONTRACT_START_DATE_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="合同结束日期" id="CONTRACT_END_DATE_SEARCH">
										</div>
									</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/personnel/contract/list.js"></script>
