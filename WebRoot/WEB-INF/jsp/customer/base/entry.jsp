...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card">
							...
							<div class="body">
							    <!-- 客户表的主键ID -->
								<input type="hidden" id="CLIENT_ID" value="${pd.CLIENT_ID}" v-model="CLIENT_ID">
								<!-- 类型 -->
								<input type="hidden" id="type" value="${pd.type}" v-model="type">
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="名称" type="text" id="client_name" v-model="CLIENT_NAME">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="地址" type="text" id="client_address" v-model="CLIENT_ADDRESS">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="联系电话" type="text" id="client_tel" v-model="CLIENT_TEL">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="邮箱" type="text" id="client_mail" v-model="CLIENT_MAIL">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
		...
		<!-- js -->
		<script type="text/javascript" src="static/js/modules/customer/entry.js"></script>
	</body>
