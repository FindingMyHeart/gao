...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="-- 订单号 --" type="text" id="ORDER_NO_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="IO_FLAG_SEARCH">
											<option value="">-- 类型 --</option>
											<option value="1">入库</option>
											<option value="2">出库</option>
											<option value="3">退库</option>
											<option value="4">特殊入库</option>
											<option value="5">特殊出库</option>
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control z-index show-tick" data-live-search="true" id="SUPPLIER_ID_SEARCH">
						...
						<div class="card">
							...
							<div class="body">
								<div class="table-responsive">
									<table class="layui-hide table table-striped" id="ccdd" lay-filter="ccdd"></table>
									<script type="text/html" id="barDemo">
										...
										<button class="btn btn-primary btn-xs" style="display: none;">下载</button>
									</script>
								</div>
							</div>
						</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/store/ddcx/list.js"></script>
