...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">库位登记</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="库位名称" type="text" id="location_name_search">
										</div>
									</div>
						...
						<div class="card">
							...
							<div class="body">
								<div class="table-responsive">
									<table class="layui-hide table table-striped" id="kwgl" lay-filter="kwgl"></table>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/store/kwgl/list.js"></script>
