...
<body class="theme-black">
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="资质编号" type="text" v-model = "CERT_CODE">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="资质名称" type="text" v-model = "CERT_NAME">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="input-group">
											...
											<input type="text" class="form-control datetimepicker" placeholder="有效期" v-model = "VALID_DATE">
										</div>
									</div>
								</div>
							</div>
		...
		<!-- js -->
        <script type="text/javascript" src="static/js/modules/adm/cert/entry.js"></script>
	</body>
