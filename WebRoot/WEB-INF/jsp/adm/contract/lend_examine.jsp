...
<html class="no-js " lang="utf-8">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">合同登记</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="合同编号" type="text" id="CONTRACT_CODE_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="合同名称" type="text" id="CONTRACT_NAME_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="CONTRACT_TYPE_SEARCH">
											<option value="">-- 合同类型 --</option>
											<c:forEach var="p" items="${fns:getDicListByType('htlx')}">
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										<!-- 如果是审核中的状态  -->
										{{# if(d.STATUS == "1" && d.USE_CASE == "1" ){ }}
										<button type="button" class="btn bg-orange btn-xs" lay-event="adopt">通过</button> {{# } }} {{# if(d.STATUS == "1"){ }}
	...
	<!-- Js -->
	<script type="text/javascript" src="static/js/modules/adm/contract/lend_examine.js"></script>
