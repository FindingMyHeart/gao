    ...
    methods:{
            ...
            layui.use('table', function(){
                ...
                table.on('tool(layList)', function(obj){
                    ...
                    if(obj.event === 'detail'){
                        ...
                        vm.adopt(data.TRANSFER_ID);
                    } else if(obj.event === 'reject'){
                        vm.reject(data.TRANSFER_ID);
                    }
                });
        ...
        adopt:function(TRANSFER_ID){
            swal({
                ...
                myjstools.ajax(false, "POST", "/web/service?METHOD=staffTransfer_updateStatus",{
