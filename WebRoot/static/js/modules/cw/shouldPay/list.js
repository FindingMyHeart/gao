...
var vm = new Vue({
    ...
    data:{
        columns:[[
            ...
            ,{field:'CONTRACT_PRICE', title: '总欠款金额',width:140}
            ,{field:'UN_PAY_MONEY', title: '未付款金额',width:140}
            ,{field:'ADD_ACCOUNT_MONEY', title: '结算金额',width:100}
            ,{field:'CAIWU_STATUS', title: '财务状态',align:'center',width:100}
