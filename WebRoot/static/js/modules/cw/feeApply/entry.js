var vm_entry = new Vue({
    ...
    data:{
        ...
        BUY_SUPPLIER_ID:'',//供应商
        BUY_CONTRACT_LIST:[],//采购合同列表
        BUY_FEE_TYPE:'',//采购付款类型
        BUY_INVOICE_TYPE:'',//采购票据类型
        CONTRACT_PRICE:'',//合同金额

        BORROW_REAL_MONEY:'',//实际金额
        BORROW_BACK_MONEY:'',//退回金额
        BORROW_BU_MONEY:'',//补领金额

        BAOXIAO_TYPE:'',//报销类型
        BAOXIAO_INVOICE_NUM:'',//报销张数

        CHAILV_LOCATION:'',//出差地点
        CHAILV_START_LOCATION:'',//出发地点
        CHAILV_START_DATE:'',//出发时间
        CHAILV_END_LOCATION:'',//到达地点
        CHAILV_END_DATE:'',//到达时间
        CHAILV_PERSON_NUM:'',//人数
        CHAILV_DAY_NUM:'',//天数


        ADD_PAYMENT_MODE:'',//添加信息----付款方式
        CW_KAIHU_BANK:'',//开户行（财务）
        ADD_ACCOUNT_ID:'',//添加信息----支付账户id
        CW_ACCOUNT_LIST:[],//开户行列表
...
$(function(){
    ...
    layui.use('laydate', function(){
        ...
        //执行一个laydate实例
        laydate.render({
            elem: '#CHAILV_START_DATE' //指定元素
        });
        laydate.render({
            elem: '#CHAILV_END_DATE' //指定元素
        });
    });
});
