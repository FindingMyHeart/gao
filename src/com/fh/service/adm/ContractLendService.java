 ...
 */
@Service("contractLendService")
public class ContractLendService {
    @Autowired
    ...
    public void save(PageData pd) throws Exception {
        ...
        pd.put("IF_DELETED", "0");
        admContractLendService.save(pd);
...
//        admCertInfoService.updateUseCase(params);
    ...
    public void delete(PageData pd) throws Exception {
        ...
        admContractLendService.delete(pd);
    }
    ...
    public void edit(PageData pd) throws Exception {
        ...
        admContractLendService.edit(pd);
    }
    ...
    public PageData findById(PageData pd) throws Exception {
        ...
        result = admContractLendService.findById(pd);
        return result;
    }
    ...
    public List<PageData> list(Page page) throws Exception {
        return admContractLendService.list(page);
    }
    ...
    public List<PageData> listAll(PageData pd) throws Exception {
        return admContractLendService.listAll(pd);
    }
    ...
    public void deleteBatch(PageData pd) throws Exception {
        ...
        admContractLendService.deleteAll(ArrayDATA_IDS);
    }
    ...
    public void updateStatus(PageData pd) throws Exception {
        ...
        if(pd.get("STATUS").toString().equals("2") && (pd.get("CONTRACT_ID") == null || pd.get("CONTRACT_ID").toString().equals(""))){
            throw new Exception("无效的操作！");
        }
        ...
        if(STATUS.equals("2")){
            String CONTRACT_ID = pd.get("CONTRACT_ID").toString();
            PageData params = new PageData();
            params.put("CONTRACT_ID",CONTRACT_ID);
            PageData result = admContractInfoService.findById(params);
            if(result == null){
                throw new Exception("无效的操作！");
            }
            ...
            admContractInfoService.updateUseCase(params);
        }
        admContractLendService.updateStatus(pd);
    }
}
