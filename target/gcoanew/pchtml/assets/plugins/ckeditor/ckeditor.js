	...
	window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function() {
			...
			CKEDITOR.tools = {
				...
				buildStyleHtml: function(a) {
					...
					for(var g, f = [], b = 0; b < a.length; b++)
						if(g = a[b]) /@import|[{}]/.test(g) ? f.push("\x3cstyle\x3e" +
				...
				for(var a; this.getFirst && (a = this.getFirst());) {
					if(a.type == CKEDITOR.NODE_TEXT) {
						var e = CKEDITOR.tools.ltrim(a.getText()),
							b = a.getLength();
						if(e) e.length <
							b && (a.split(b - e.length), this.$.removeChild(this.$.firstChild));
						else {
							a.remove();
							continue
						}
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {
			...
			var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
				k = e.getCustomData("list_marker_names") ||
			...
			CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
				...
				getDocumentPosition: function(a) {
					...
					if(document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
						...
						for(t = this, p = null; t && "body" != t.getName() &&
							"html" != t.getName();) {
		...
		function() {
			function a(a, b) {
				...
				this.current ? c = this.current[k](!1, n, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < l ? c.getChild(l - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, n, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT &&
					((c = c.getChild(f)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))), c && !1 === h(c) && (c = null));
				for(; c && !this._.end;) {
					this.current = c;
			...
			CKEDITOR.dom.walker.invisible = function(a) {
				...
				return function(c) {
					b(c) ? c = 1 : (c.type == CKEDITOR.NODE_TEXT &&
						(c = c.getParent()), c = c.$.offsetWidth <= g);
					return !!(a ^ c)
				}
			};
		...
		function() {
			...
			function e(a, b, c, d, f) {
				...
				if(r && C.type == CKEDITOR.NODE_TEXT && w.equals(C)) w = a.document.createText(w.substring(x, B)), c.append(w);
					...
					for(var N = w.getParents(), H = C.getParents(), R = h(), P = N.length -
							1, T = H.length - 1, O = c, J, ca, W, U = -1, K = R; K <= P; K++) {
						ca = N[K];
						W = ca.getNext();
			...
			CKEDITOR.dom.range.prototype = {
				...
				cloneContents: function(a) {
					...
					this.collapsed ||
						e(this, 2, b, !1, "undefined" == typeof a ? !0 : a);
					return b
				},
				...
				createBookmark2: function() {
					function a(b) {
						...
						f = g;
						var l = d;
						f = f.type != CKEDITOR.NODE_ELEMENT || 0 === l || l == f.getChildCount() ?
							0 : f.getChild(l - 1).type == CKEDITOR.NODE_TEXT && f.getChild(l).type == CKEDITOR.NODE_TEXT;
						...
						if(g.type == CKEDITOR.NODE_TEXT) {
							...
							f = l;
							g.getText() ? d += f : (l = g.getPrevious(c), f ? (d = f, g = l ? l.getNext() : g.getParent().getFirst()) : (g =
					...
					return function(c) {
						...
						c && (a(f),
							b(f, this.root), d || (a(l), b(l, this.root)));
						return {
				...
				enlarge: function(a, b) {
					...
					switch(a) {
						...
						case CKEDITOR.ENLARGE_ELEMENT:
							...
							B.type == CKEDITOR.NODE_TEXT ? (F && (B = !CKEDITOR.tools.trim(B.substring(0, F)).length && B, x = !!B), B && ((w = B.getPrevious()) || (r = B.getParent()))) : (F && (w = B.getChild(F - 1) || B.getLast()),
								w || (r = B));
							for(r = c(r); r || w;) {
								if(r && !w) {
									!C && r.equals(h) && (C = !0);
							...
							r = w = null;
							C = x = !1;
							B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(F)).length ? x = !0 : (x = !B.getLength(), F == B.getLength() ? (w = B.getNext()) ||
								(r = B.getParent()) : l(B, F) && (r = B.getParent())) : (w = B.getChild(F)) || (r = B);
							for(; r || w;) {
								if(r && !w) {
									!C && r.equals(h) && (C = !0);
									if(f ? r.isBlockBoundary() : !e.contains(r)) break;
				...
				shrink: function(a, b, c) {
					if(!this.collapsed) {
						...
						var d = this.clone(),
							...
							k = 1,
							m = 1;
						f && f.type == CKEDITOR.NODE_TEXT && (h ? h >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), k =
						...
						d.guard = function(b, d) {
							if(r(b)) return !0;
							if(a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(w) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT &&
				...
				moveToClosestEditablePosition: function(a, b) {
					...
					else if(f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (l = f.type ==
						CKEDITOR.NODE_ELEMENT) && f.is(CKEDITOR.dtd.$block) && "false" == f.getAttribute("contenteditable") ? (c.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && l && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(f, 0), c.collapse()) : c.moveToPosition(f, h[b ? 1 : 0]);
		...
		1, CKEDITOR.SHRINK_TEXT = 2, "use strict",
		function() {
			function a(a) {
				...
				getNextParagraph: function(a) {
					...
					if(!this._.started) {
						...
						t.collapsed || (e = new CKEDITOR.dom.walker(t.clone()), p = CKEDITOR.dom.walker.bookmark(!0, !0), e.evaluator = p, this._.nextNode = e.next(), e = new CKEDITOR.dom.walker(t.clone()), e.evaluator = p, e = e.previous(), this._.lastNode = e.getNextSourceNode(!0, null, t.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (p = this.range.clone(), p.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), p.checkEndOfBlock() &&
							(p = new CKEDITOR.dom.elementPath(p.endContainer, p.root), this._.lastNode = (p.block || p.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(e)), t = null);
						this._.started = 1;
						e = t
					}
					p = this._.nextNode;
		...
		function() {
			function a(a, b, c, d, f) {
				...
				for(d = a.length; c < d; ++c) {
					...
					for(k in N) {
						...
						t = [];
						z = void 0;
						for(z in w) - 1 < z.indexOf("*") ? t.push(new RegExp("^" +
							z.replace(/\*/g, ".*") + "$")) : t.push(z);
						w = t;
						w.length && (l[h] = w, r = !1)
					}
					l.nothingRequired = r;
			...
			function e(a, c, d, g) {
				if(!a.match || a.match(c))
					if(g || f(a, c))
						if(a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles,
			...
			function u(a, b, d, f) {
				...
				if(f.doFilter) {
					a: {
						h =
						b.name;k = a._;a = k.allowedRules.elements[h];l = k.allowedRules.generic;h = k.disallowedRules.elements[h];k = k.disallowedRules.generic;r = f.skipRequired;
						var m = {
								valid: !1,
								validAttributes: {},
								validClasses: {},
						...
						if(a || l) {
							...
							if(l)
								for(z =
									0, C = l.length; z < C; ++z) e(l[z], b, m, r);
							a = m
						} else a = null
					}
					...
					if("br" == b) a.previous && !z(a.previous) && (b = A(), b.insertBefore(a)), a.next && !z(a.next) && (b = A(), b.insertAfter(a)), a.replaceWithChildren();
						...
						if(f) a.name = b, a.attributes = {}, c.push({
							...
							for(var g = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, h, k, l = d.length; 0 < l;) e = d[--l], g && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && F.$inline[e.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
								check: "parent-down",
								el: h
							})), h.add(e, 0)) : (h = null, k = F[f.name] || F.span, e.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT ||
								k[e.name] || c.push({
									check: "el-up",
									el: e
								}));
				...
				applyTo: function(a, b, c, d) {
					...
					for(; m = a.pop();)
						if(c = m.el, c.parent) switch(w = F[c.parent.name] || F.span, m.check) {
							...
							case "el-up":
								c.parent.type ==
									CKEDITOR.NODE_DOCUMENT_FRAGMENT || w[c.name] || r(c, d, a);
								break;
							case "parent-down":
					...
					if(!this.disabled && a) {
						...
						for(f = 0; f < a.length; ++f) {
							...
							var g = void 0,
								...
								r = void 0;
							c = [];
							for(e = 0; e < b.length; ++e) l = b[e], "string" == typeof l ? (l = l.split(/\s*:\s*/), h = l[0], k = null, r = l[1]) : (h = l.check, k = l.left, r = l.right), g || (g = l, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] :
								g.left.getDefinition().element), k instanceof CKEDITOR.style && (k = B(k)), c.push({
								check: h == g ? null : h,
								left: k,
					...
					m = function(b) {
						a.call(this, b, function(a) {
							...
							for(f in a) {
								...
								if(v)
									for(v.split && (v = v.split(",")), n = 0; n < v.length; n++) k[v[n]] ||
										b.push(v[n])
							}
						...
						if(a(f)) p.push(f);
							...
							if("br" == d) y.push(f);
								...
								for(; !(k = (g = A.name) ? CKEDITOR.dtd[g] || (A._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || A.isUnknown || k[d]);)
									...
									else if(d in b && g in b) g = A.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"),
									A), !f.returnPoint && (f.returnPoint = A), A = g;
		...
		function() {
			function a(a,
				...
				function e(a, d) {
					return function(f) {
						if(f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
							...
							if(e = !a || !1 !== ("function" == typeof d ? d(f) : d)) z || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ?
								z || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (e = b(f), e = !e || "form" == f.name && "input" == e.name) : e = !1 : e = !1;
							e && f.add(g(a))
						}
					}
				}
				...
				function l(a, b) {
					...
					var c;
					return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(p)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller &&
			...
			var p = /(?:&nbsp;|\xa0)$/,
				...
				r = CKEDITOR.tools.extend({}, A.$blockLimit,
					A.$block),
				w = {
					elements: {
						input: f,
		...
		function() {
			CKEDITOR.inline = function(a, e) {
				...
				var b = new CKEDITOR.editor(e,
						a, CKEDITOR.ELEMENT_MODE_INLINE),
		...
		function() {
			...
			function b(a) {
				var b = a.name,
					...
					l = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' :
		...
		function() {
			function a(a) {
				...
				}, !f.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = l.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(),
					h = 1, a.cancel());
				h && l.select()
			}
			...
			CKEDITOR.editable = CKEDITOR.tools.createClass({
				...
				proto: {
					...
					insertElementIntoRange: function(a,
						...
						if(g)
							for(;
								(e = b.getCommonAncestor(0, 1)) && (l = CKEDITOR.dtd[e.getName()]) && (!l || !l[f]);) e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ?
								"div" : "p", c.editable());
						b.insertNode(a);
						return !0
					},
					...
					fixInitialSelection: function() {
						function a() {
							...
							f && (f = new CKEDITOR.dom.range(c), f.moveToElementEditStart(c), b = b.createRange(), b.setStart(f.startContainer.$, f.startOffset), b.collapse(!0), d.removeAllRanges(),
								d.addRange(b))
						}
					...
					setup: function() {
						...
						if(!this.is("textarea")) {
							...
							if(e) {
								...
								h ? e != h.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? h.$.styleSheet.cssText =
									...
									if(c in m) {
										...
										CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = k(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove(), e.select(), a.fire("saveSnapshot"), d = 1) : e.collapsed && ((h = l.block) && (n = h[c ? "getPrevious" : "getNext"](g)) && n.type == CKEDITOR.NODE_ELEMENT && n.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ?
											(a.fire("saveSnapshot"), e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && h.remove(), e["moveToElementEdit" + (c ? "End" : "Start")](n), e.select(), a.fire("saveSnapshot"), d = 1) : l.blockLimit && l.blockLimit.is("td") && (r = l.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (n = r[c ? "getPrevious" : "getNext"](g)) ? (a.fire("saveSnapshot"), e["moveToElementEdit" + (c ? "End" : "Start")](n), e.checkStartOfBlock() && e.checkEndOfBlock() ? n.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (r = l.contains(["td",
												"th", "caption"
											])) && e.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
									}
									return !d
								});
			...
			t = function() {
				...
				function b(c, d) {
					...
					f = d.range.startPath();
					for(var m = k[m.getName()], n = 0, y = c.getChildren(), p = y.count(), q = -1, w = -1, t = 0, C = f.contains(k.$list); n < p; ++n) f = y.getItem(n), a(f) ? (e = f.getName(), C && e in CKEDITOR.dtd.$list ?
						h = h.concat(b(f, d)) : (l = !!m[e], "br" != e || !f.data("cke-eol") || n && n != p - 1 || (t = (g = n ? h[n - 1].node : y.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && k.$block[g.getName()]), -1 != q || l || (q = n), l || (w = n), h.push({
							isElement: 1,
							isLineBreak: t,
				...
				function l(b, c, d, f) {
					...
					(e = (new CKEDITOR.dom.walker(g)).next()) && a(e) && n[e.getName()] && (h = e.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && d.contains(h) &&
				...
				return function(n, q, H, t) {
					...
					if(!t.checkReadOnly()) {
						...
						t = n.mergeCandidates;
						var J, E;
						"text" == n.type && q.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (J = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
							q.document), q.insertNode(J), q.setStartAfter(J));
						...
						if(J) {
							...
							var A = n.endPath.elements[0],
								Z, v = A.getPosition(q),
								W = !!A.getCommonAncestor(q) && v != CKEDITOR.POSITION_IDENTICAL && !(v & CKEDITOR.POSITION_CONTAINS +
							...
							for(h(q, K); t < q.length; t++) {
								...
								if(M) H = 0 < t;
									...
									M = K.startPath();
									!v.isBlock && m(n.editor, M.block, M.blockLimit) && (Y = f(n.editor)) && (Y = J.createElement(Y),
										Y.appendBogus(), K.insertNode(Y), CKEDITOR.env.needsBrFiller && (S = Y.getBogus()) && S.remove(), K.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
							...
							S && (H = !0, M = q[0].node, K.setStartAt(M, CKEDITOR.POSITION_BEFORE_START),
			...
			y = {
				eol: {
					detect: function(a, b) {
						...
						d.collapse(1);
						f.collapse();
						g.block && d.checkBoundaryOfElement(g.block,
							CKEDITOR.END) && (c.setStartAfter(g.block), a.prependEolBr = 1);
				...
				tree: {
					rebuild: function(a, b) {
						...
						} else if(f.block && f.block.is(CKEDITOR.dtd.$listItem) && (g = g.contains(CKEDITOR.dtd.$list),
								c = c.contains(CKEDITOR.dtd.$list), !g.equals(c))) {
						...
						return {
							detectPurge: function(a) {
								...
								if(1 < f) {
									...
									c && g && b.checkBoundaryOfElement(c, CKEDITOR.START) && b.checkBoundaryOfElement(g,
							...
							detectRanges: function(f, g) {
								...
								m = m.contains("table");
								k = k.contains("table");
								if(m || k) m && k && b(m, k) ? (f.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END),
				...
				return function(c) {
					...
					if(b[d]) {
						var f = a.getSelection().getRanges(),
							g = f[0];
						1 == f.length && g.collapsed && (d = g[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") && (a.getSelection().fake(d),
				...
				for(var b = 0; b < a.length; b++) {
					...
					if(!c.collapsed) {
						...
						var g = c.startOffset,
							e = c.endOffset,
							h = c.clone();
						d && d.type == CKEDITOR.NODE_TEXT && (g >= d.getLength() ?
			...
			CKEDITOR.dom.selection = function(a) {
				...
				if(a)
					if(a.getRangeAt) d = (f = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(f.commonAncestorContainer);
						...
						d = f && CKEDITOR.dom.element.get(f.item &&
				...
				getType: t ? function() {
					...
					if(!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
						...
						var c = c.getRangeAt(0),
							d = c.startContainer;
						d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && y[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
								...
								if(t) {
									...
									for(p = 0; p < a.length; p++) {
										...
										try {
											...
											if(0 <=
												H.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) e.collapse(1), q.setEnd(e.endContainer.$, e.endOffset);
											else throw H;
										}
										g.addRange(q)
									}
		...
		function() {
				...
				if(c.collapsed) f = y(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
					...
					for(A.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (A = 0); A;) {
						...
						if(k && r && !r.collapsed) {
							...
							k ? (r.extractContents().appendTo(k), r.insertNode(k),
								q.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), r.extractContents().appendTo(k), r.insertNode(k), q.call(this, k), k.remove(!0));
							r = null
						}
					}
					c.moveToBookmark(p);
			...
			function c(a) {
				...
				if(a.collapsed) {
					...
					var k = c.endNode,
						m = this;
					b();
					for(f = d; !f.equals(k);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ?
			...
			function u(a, b) {
				var c = this._.definition,
					...
					e;
				for(e in d)
					if("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == w(e, d[e])) b &&
			...
			CKEDITOR.style.prototype = {
				...
				applyToRange: function(a) {
					this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type ==
						CKEDITOR.STYLE_BLOCK ? f : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
		...
		function(a, e) {
			...
			split: function(a) {
				...
				e.childNodes.length ==
					b && (a >= c ? (k = d.createText(""), k.insertAfter(this)) : (a = d.createText(""), a.insertAfter(k), a.remove()));
				return k
			},
		...
		function() {
			...
			if(a = CKEDITOR._.pending)
				for(delete CKEDITOR._.pending, e = 0; e < a.length; e++) CKEDITOR.editor.prototype.constructor.apply(a[e][0],
		...
		function() {
			...
			function v(a) {
				...
				g ? g.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ?
					"absolute" : "fixed", "; z-index: ", e, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'
			...
			function u(a) {
				x && (a.focusManager.remove(x),
					a = CKEDITOR.document.getWindow(), x.hide(), a.removeListener("resize", w), CKEDITOR.env.ie6Compat && a.$.setTimeout(function() {
			...
			CKEDITOR.dialog = function(b, f) {
				...
				function n(c) {
					if(x == CKEDITOR.dialog._.currentTop) {
						...
						if(9 == d || d == CKEDITOR.SHIFT + 9) m(d == CKEDITOR.SHIFT + 9 ? -1 : 1), w = 1;
								...
								d) && x._.tabBarMode) d = -1 != CKEDITOR.tools.indexOf([f ? 39 : 37, 38], d) ? a.call(x) : e.call(x), x.selectPage(d), x._.tabs[d][0].focus(), w = 1;
				...
				this.on("show", function() {
					...
					b.config.dialog_startupFocusTab && a ? (x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, q.onFocus ?
			...
			CKEDITOR.ui.dialog.uiElement.prototype = {
				...
				registerEvents: function(a) {
					var b = /^on([A-Z]\w+)/,
						...
						f;
					for(f in a)
						if(c = f.match(b)) this.eventProcessors[f] ? this.eventProcessors[f].call(this,
							...
							if(a.config.enterMode == CKEDITOR.ENTER_BR)
								for(d = !0; b.length;)
									if(l = b.shift(), "div" == l.getName()) {
										...
										for(d = l.getNext() &&
											!(l.getNext().type == CKEDITOR.NODE_ELEMENT && l.getNext().isBlockBoundary()); l.getFirst();) l.getFirst().remove().appendTo(f);
			...
			CKEDITOR.plugins.add("clipboard", {
				...
				init: function(a) {
					...
					a.on("paste", function(d) {
							...
							var f = d.type,
								e = d.dataValue,
								h, m = a.config.clipboard_defaultContentType ||
								"html",
		...
		function() {
			function a(a, c, d, k, m) {
				...
				var f = e[m];
				f || (f = e[m] = new CKEDITOR.ui.panel(c,
					k), f.element = d.append(CKEDITOR.dom.element.createFromHtml(f.render(a), c)), f.element.setStyles({
					display: "none",
					position: "absolute"
				}));
				return f
				...
				proto: {
					...
					showBlock: function(a, c, d, e, m, f) {
						...
						var n = this.element,
							...
							p = q.x + (e || 0) - v.x,
							y = q.y + (m || 0) - v.y;
						!t || 1 != d && 4 != d ? t || 2 != d && 3 != d || (p += c.$.offsetWidth -
							1) : p += c.$.offsetWidth;
					...
					showAsChild: function(a, c, d, e, m, f) {
						if(this._.activeChild != a || a._.panel._.offsetParentId != d.getId()) this.hideChild(), a.onHide = CKEDITOR.tools.bind(function() {
							...
							}, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, d, e, m, f), this.blur(),
			...
			CKEDITOR.plugins.indent.specificDefinition.prototype = {
				...
				refreshJob: function(a, b, k) {
					...
					a.activeFilter.checkFeature(this) ?
						b.state = b.refresh.call(this, a, k) : b.state = e;
					return b.state
				},
		...
		function() {
			function a(a) {
				function c(e) {
					...
					for(var q =
							d.isIndent ? 1 : -1, m = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(e, g), w = t[h.getCustomData("listarray_index")].indent, m = m.getCustomData("listarray_index"); m <= h.getCustomData("listarray_index"); m++)
						if(t[m].indent += q, 0 < q) {
							var v = t[m].parent;
				...
				for(var d = this, g = this.database, k = this.context, m = a.getSelection(), m = (m && m.getRanges()).createIterator(),
					...
					q && u.startContainer.type == CKEDITOR.NODE_ELEMENT && u.startContainer.getName() in k && (t =
						new CKEDITOR.dom.walker(u), t.evaluator = e, u.startContainer = t.next());
						...
						this.jobs[this.isIndent ? 10 : 30] = {
							refresh: this.isIndent ? function(a, b) {
								var c = this.getContext(b),
									d = CKEDITOR.plugins.indentList.firstItemInPath(this.context,
										b, c);
		...
		function() {
			function a(a, b, c) {
				...
				for(var f = CKEDITOR.plugins.list.listToArray(b.root, c), e = [], g = 0; g < b.contents.length; g++) {
					var h = b.contents[g];
					(h = h.getAscendant("li", !0)) && !h.getCustomData("list_item_processed") && (e.push(h), CKEDITOR.dom.element.setMarker(c,
			...
			function k(a, d, f) {
				...
				(l = e.getLast()) && l.type == CKEDITOR.NODE_ELEMENT &&
					l.is("br") && l.remove();
					...
					for(var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, u = c, v = Math.max(a[c].indent, 0), D = null, F, E, I = d == CKEDITOR.ENTER_P ? "p" : "div";;) {
						...
						if(G.indent == v) {
							n && a[u].parent.getName() ==
								n.getName() || (n = a[u].parent.clone(!1, 1), e && n.setAttribute("dir", e), m.append(n));
							...
							D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && u != a.length - 1 && (CKEDITOR.env.needsBrFiller &&
								(F = D.getLast()) && F.type == CKEDITOR.NODE_ELEMENT && F.is("br") && F.remove(), (F = D.getLast(g)) && F.type == CKEDITOR.NODE_ELEMENT && F.is(CKEDITOR.dtd.$block) || D.append(k.createElement("br")));
					...
					if(b)
						for(a = m.getFirst(); a;) {
							if(a.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, k = e = d = void 0, d = c.getDirection()))) {
								for(e =
									c.getParent(); e && !(k = e.getDirection());) e = e.getParent();
			...
			e.prototype = {
				exec: function(b) {
					...
					for(var d = e.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0;
						...
						l = l.createIterator();
						for(l.forceBrBreak =
							this.state == CKEDITOR.TRISTATE_OFF; u = l.getNextParagraph();)
							if(!u.getCustomData("list_block")) {
								...
								B || (B = D, B.getCustomData("list_group_object_" +
									n) ? B.getCustomData("list_group_object_" + n).contents.push(u) : (x = {
									root: B,
									contents: [u]
								...
								if(h && h.collapsed) {
									...
									if(u) {
										...
										(x = l.contains(f)) && h.checkBoundaryOfElement(x, CKEDITOR.START) && (x = x.getParent()) && x.is("li") && (x = m(x)) ? (e = x, x = x.getPrevious(g), c.moveToPosition(x && n(x) ? x : e, CKEDITOR.POSITION_BEFORE_START)) : (C.range.setStartAt(v, CKEDITOR.POSITION_AFTER_START), C.range.setEnd(h.startContainer, h.startOffset), (x = C.previous()) && x.type == CKEDITOR.NODE_ELEMENT && (x.getName() in f || x.is("li")) && (x.is("li") || (C.range.selectNodeContents(x),
											C.reset(), C.evaluator = d, x = C.previous()), e = x, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
					...
					if(k = k || e(a)) {
						...
						if(q && t) {
							if(y && (y.is("li") || y.getParent().is("li"))) {
								...
								if(z.is("li")) v || r ? (v && r && k.remove(), y[r ? "insertAfter" : "insertBefore"](z)) :
									y.breakParent(z);
								else {
									if(a)
						...
						if(q = k.splitBlock(A)) {
							...
							p = q.wasStartOfBlock;
							a = q.wasEndOfBlock;
							y ? (w = y.getParent(), w.is("li") && (y.breakParent(w), y.move(y.getNext(), 1))) : f && (w = f.getParent()) && w.is("li") && (f.breakParent(w), w = f.getNext(), k.moveToElementEditStart(w),
							...
							}, (w = z.next()) && w.type == CKEDITOR.NODE_ELEMENT && w.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? u.createElement("br") :
								u.createText(" ")).insertBefore(w)), y && k.moveToElementEditStart(y);
							k.select();
							k.scrollIntoView()
						}
					}
				...
				enterBr: function(a, b, c, d) {
					if(c = c || e(a)) {
						var k = c.document,
							...
							p = t.block,
							y = p && t.block.getName();
						d || "li" != y ? (!d && m && h.test(y) ? (m = p.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", m), k.insertAfter(p), c.setStart(k, 0)) : (k.createElement("br").insertAfter(p), CKEDITOR.env.gecko && k.createText("").insertAfter(p),
		...
		function() {
			...
			init: function(a) {
				if(!a.blockless) {
					for(var e =
							a.config, b = a.lang.format, c = e.format_tags.split(";"), d = {}, k = 0, m = [], f = 0; f < c.length; f++) {
						var h = c[f],
		...
		function() {
			...
			CKEDITOR.plugins.link = {
				...
				parseLinkAttributes: function(a, b) {
					...
					if(!C.type)
						if(r = c.match(h)) C.type =
							"anchor", C.anchor = {}, C.anchor.name = C.anchor.id = r[1];
						else if(r = c.match(k)) {
						w = c.match(m);
						c = c.match(f);
						C.type = "email";
					...
					if(b) {
						if(c = b.getAttribute("target")) C.target = {
							...
							for(C.target = {
								...
								q.exec(c[2]);) "yes" != r[2] && "1" != r[2] || r[1] in {
								height: 1,
								width: 1,
								top: 1,
								left: 1
		...
		function() {
			...
			function f(a) {
				var b = a.doc,
					...
					d = CKEDITOR.getUrl(this.path + "images/" +
						(E.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") + ".png");
				B(c, {
					attach: function() {
					...
					place: function() {
						...
						g.equals(c) ? (l.left = b.scroll.x, l.right = -b.scroll.x, l.width = "") : (l.left = h.size.left - h.size.margin.left + b.scroll.x -
							(a.inInlineMode ? b.editable.left + b.editable.border.left : 0), l.width = h.size.outerWidth + h.size.margin.left + h.size.margin.right + b.scroll.x, l.right = "");
						...
						d.is(T) || k(l.top, b.scroll.y - 15, b.scroll.y + 5) ? (l.top = a.inInlineMode ?
							0 : b.scroll.y, this.look(T)) : d.is(O) || k(l.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (l.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(O)) : (a.inInlineMode && (l.top -= b.editable.top + b.editable.border.top), this.look(J));
			...
			function A(a) {
				...
				if(v(g) ||
					p(a, g, u) || g.getParent().is(W)) return null;
				var t = d(a, g, !u);
				if(t) {
				...
				} else g.equals(a.editable[u ? "getLast" : "getFirst"](a.isRelevant)) ? (w(a), u && k(c.y, g.size.bottom - h, f.pane.height) && k(g.size.bottom, f.pane.height - h, f.pane.height) ? m = O : k(c.y, 0, g.size.top + h) && (m = T)) : m = J, l = [null, g][u ? "reverse" : "concat"]().concat([u ? H : N, P, m, g.equals(a.editable[u ? "getLast" : "getFirst"](a.isRelevant)) ?
					u ? O : T : J
				]);
			...
			function z(a, b, c, d) {
				...
				k.height = k.outerHeight -
					(g.top + g.bottom + e.top + e.bottom);
						...
						k.is(G.$inline) || (m.inInlineMode && !u(k) && k.setStyles({
							...
							if("wysiwyg" == a.mode && !a.readOnly && !r) {
								...
								r = setTimeout(function() {
									...
									r = m.trigger = null;
									C(m);
									p && !m.hiddenMode && a.focusManager.hasFocus && !m.line.mouseNear() && (m.element = da(m, !0)) && ((m.trigger = y(m) || A(m) || ga(m)) &&
							...
							l(m)), a.addCommand("accessNextSpace", l(m, !0)), a.setKeystroke([
		...
		function() {
			function a(a) {
				if(!a ||
					a.type != CKEDITOR.NODE_ELEMENT || "form" != a.getName()) return [];
					...
					if(a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
						...
						a.addCommand("maximize", {
							...
							exec: function() {
								...
								"wysiwyg" ==
								a.mode ? g ? (CKEDITOR.env.gecko && d(a), a.getSelection().selectRanges(g), (y = a.getSelection().getStartElement()) && y.scrollIntoView(!0)) : l.$.scrollTo(n.x, n.y) : (g && (y.selectionStart = g[0], y.selectionEnd = g[1]), y.scrollLeft = n[0], y.scrollTop = n[1]);
								g = n = null;
								u = this.state;
						...
						a.on("mode", function() {
							...
							b.setState(b.state == CKEDITOR.TRISTATE_DISABLED ?
		...
		function() {
						...
						for(var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter,
							...
							if(g)
								for(n(g), l = l.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); l && !l.equals(g);)
									if(l.isReadOnly()) {
										if(l.getPosition(g) &
											CKEDITOR.POSITION_CONTAINS) break;
										l = l.getNext(m)
			...
			init: function(a) {
				...
				void 0 === c.resize_maxHeight && (c.resize_maxHeight =
					3E3);
				...
				if(!1 !== c.resize_enabled) {
					var m = null,
						...
						n = CKEDITOR.tools.addFunction(function(d) {
							...
							c.resize_minWidth >
								h.width && (c.resize_minWidth = h.width);
					...
					a.on("uiSpace", function(b) {
						if("bottom" == b.data.space) {
							...
							var f = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' +
								c + " cke_resizer_" + k + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == k ? "◢" : "◣") + "\x3c/span\x3e";
			...
			onLoad: function() {
				var a = function(a) {
					...
					b.state !== CKEDITOR.TRISTATE_DISABLED &&
						(b.on && c ? c.hide() : (b.previousState = b.state, c || (c = b.menu = new CKEDITOR.menu(a, {
							panel: {
								className: "cke_menu_panel",
								attributes: {
			...
			init: function(a) {
				...
				a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
					...
					refresh: function() {
						...
						a.scayt && (c = b.state.scayt[a.name] ? CKEDITOR.TRISTATE_ON :
			...
			bindEvents: function(a) {
					...
					k = function() {
						...
						c.attachListener(c, "focus", function(c) {
							...
							if((b || c) && a._.savedSelection) {
								...
								for(var m = 0; m < c.length; m++) e = c[m], "string" ===
				...
				a.on("beforeCommandExec", function(b) {
					...
					b.data.name in e.options.disablingCommandExec && "wysiwyg" == a.mode ? c && (e.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !== b.data.name && "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name && "cut" !== b.data.name && "language" !== b.data.name || !c || ("cut" === b.data.name && (m = !1,
						g = !0), "language" === b.data.name && (d = (d = a.plugins.language.getCurrentLangElement(a)) && d.$, g = !0), a.fire("reloadMarkupScayt", {
						removeOptions: {
							removeInside: m,
							forceBookmark: g,
							selectionNode: d
			...
			parseConfig: function(a) {
				...
				if(void 0 ===
					a.config.scayt_minWordLength || "number" != typeof a.config.scayt_minWordLength || 1 > a.config.scayt_minWordLength) a.config.scayt_minWordLength = 4;
				...
				a.config.scayt_ignoreAllCapsWords &&
					"boolean" !== typeof a.config.scayt_ignoreAllCapsWords && (a.config.scayt_ignoreAllCapsWords = !1);
						...
						for(b = 0; b < e.length; b++) {
							...
							b < a.config.scayt_maxSuggestions ? (a.addMenuItem(h, {
								...
								order: b + 1
									...
									order: b + 1
								}), d[h] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions &&
			...
			menuGenerator: function(a, e) {
				...
				for(var l in c) f && -1 == CKEDITOR.tools.indexOf(k, l.replace("scayt_",
					"")) && "all" != a.config.scayt_contextCommands || (d[l] = "undefined" != typeof c[l].state ? c[l].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[l].verification || c[l].verification(a) || delete d[l], a.addCommand(l, {
					exec: c[l].exec
				}), a.addMenuItem(l, {
			...
			loadScaytLibrary: function(a, e) {
				...
				this.loadingHelper[a.name] || ("undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = e, this.loadingHelper.loadOrder.push(a.name), c = new Date, c = c.getTime(), d = a.config.scayt_srcUrl, d += 0 <= d.indexOf("?") ? "" : "?" + c, this.loadingHelper.ckscaytLoading || (CKEDITOR.scriptLoader.load(d, function(a) {
					if(a) {
						...
						for(var c =
								0; c < b.loadingHelper.loadOrder.length; c++) {
				...
				a[e] = CKEDITOR.tools.override(a[e], function(a) {
					return function(c) {
						...
						CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[c.editor.name] &&
							c.editor.scayt && (this.contents = d.removeMarkupFromString(e) || "", c.contents = d.removeMarkupFromString(m) || "");
		...
		function() {
			...
			function d(b, d) {
				...
				for(k = 0; k < l; k++) e[k] && (1 < e[k].colSpan && f[k] == e[k] ? (g = e[k], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(e[k])).clone(),
			...
			function g(b, c) {
				...
				if(1 < m) {
					...
					for(var m = Math.floor(m /
							2), f = l + n, e = new CKEDITOR.dom.element(e.$.rows[f]), g = h(g, f), v, f = d.clone(), l = 0; l < g.length; l++)
					...
					d.on("uiSpace", function(c) {
						if(c.data.space == d.config.toolbarLocation) {
										...
										for(var r = 0; r < z.length; r++) {
											...
											if(w) {
												...
												if(w.type == CKEDITOR.UI_SEPARATOR) k = g && w;
													...
													C ? g || (l.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
														g = 1) : g && (l.push("\x3c/span\x3e"), g = 0);
													k && (x(k), k = 0);
													x(w)
												}
											}
							...
							if(d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
								...
								l.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + D + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e',
									"\x3c/a\x3e")
							}
							l.push("\x3c/span\x3e");
							c.data.html += l.join("")
			...
			CKEDITOR.plugins.add("undo", {
				init: function(c) {
					...
					g.onChange = function() {
						...
						u.setState(g.redoable() ? CKEDITOR.TRISTATE_OFF :
