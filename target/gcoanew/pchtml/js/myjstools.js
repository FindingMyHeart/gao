...
var myjstools = {
	...
	, 
	/* 服务器根 */
	wwwroot: "http://localhost:8080/gcoanew"
	, 
	/* 服务器根 */
	wwwroot_image: "http://localhost:8080/gcoanew"
	,
	/* 添加标签 */
	...
	,
	/* 设置iframe高度 */
	setframeauto:function()
	{
		myjstools.setframeheight(document.body.offsetHeight);
	},
	setframeheight:function(h)
	{
		top.top_setframeheight(h);
	}
	,
	/* 弹出窗口  */
