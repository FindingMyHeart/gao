    ...
    methods:{
        ...
        save:function(){
            if(vm_entry.type == "save"){
                ...
                myjstools.ajax(false, "POST", "/web/service?METHOD=contract_save",{
                    CONTRACT_NAME:vm_entry.CONTRACT_NAME,
                    CONTRACT_CODE:vm_entry.CONTRACT_CODE,
                    CONTRACT_TYPE:vm_entry.CONTRACT_TYPE,
                ...
                myjstools.ajax(false, "POST", "/web/service?METHOD=contract_edit",{
                    CONTRACT_NAME:vm_entry.CONTRACT_NAME,
                    CONTRACT_CODE:vm_entry.CONTRACT_CODE,
                    CONTRACT_TYPE:vm_entry.CONTRACT_TYPE,
                    RESOURCEIDS:vm_entry.RESOURCEIDS,
        ...
        findInfo:function(){
            myjstools.ajax(false, "POST", "/web/service?METHOD=contract_findById",{
                CONTRACT_ID:vm_entry.CONTRACT_ID
            }, function(data){
                try {
                    if (data.success != 1) {
                    ...
                    if(data.entity.CONTRACT_CODE != null && data.entity.CONTRACT_CODE != '' && data.entity.CONTRACT_CODE != undefined){
                        vm_entry.CONTRACT_CODE = data.entity.CONTRACT_CODE;
                    }
                    if(data.entity.CONTRACT_TYPE != null && data.entity.CONTRACT_TYPE != '' && data.entity.CONTRACT_TYPE != undefined){
                        vm_entry.CONTRACT_TYPE = data.entity.CONTRACT_TYPE;
                    }
