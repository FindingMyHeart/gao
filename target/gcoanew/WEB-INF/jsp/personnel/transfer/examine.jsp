...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										{{# if(d.STATUS == "1"){ }}
										<button type="button" class="btn btn-success btn-xs waves-effect changButton" lay-event="adopt">通过</button>
										<button type="button" class="btn btn-danger btn-xs waves-effect changButton" lay-event="reject">驳回</button> 
										{{# } }}
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/personnel/transfer/examine.js"></script>
