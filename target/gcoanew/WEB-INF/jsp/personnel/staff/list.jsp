...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
						...
						<div class="card layListTable" >
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">入职登记</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="body">
								<div class="row clearfix">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="staff_status_search">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="vacation_type_search">
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										<button type="button" class="btn btn-danger btn-xs" style="display: none;">冻结</button>
										<button type="button" class="btn btn-warning btn-xs" style="display: none;">解锁</button>
									</script>
								</div>
							</div>
						</div>
        ...
        <!-- Js -->
		<script type="text/javascript" src="static/js/modules/personnel/staff/list.js"></script>
