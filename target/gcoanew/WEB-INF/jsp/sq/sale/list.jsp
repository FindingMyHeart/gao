...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5 col-sm-12">
							...
							<ul class="breadcrumb padding-0">
								...
								<li class="breadcrumb-item active">销售查询</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">销售登记</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="开票日期" type="text" id="SALE_TIME_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select id="OPEN_USERID_SEARCH">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="购货单位" type="text" id="BUY_COMPANY_SEARCH">
										</div>
									</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/sq/sale/list.js"></script>
