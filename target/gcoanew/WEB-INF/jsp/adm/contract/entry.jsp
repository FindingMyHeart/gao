...
<body class="theme-black">
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="合同编号" type="text" v-model="CONTRACT_CODE">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" v-model="CONTRACT_TYPE">
		...
		<!-- js -->
        <script type="text/javascript" src="static/js/modules/adm/contract/entry.js"></script>
	</body>
