...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">资质登记</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="资质编号" type="text" id="CERT_CODE_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="资质名称" type="text" id="CERT_NAME_SEARCH">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="USE_CASE_SEARCH">
											<option value="">-- 使用情况 --</option>
											<option value="1">在库</option>
											<option value="2">借出</option>
											<option value="3">催还</option>
											<option value="4">预期</option>
										</select>
									</div>
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										...
										<!-- 如果是借用状态 -->
										{{# if(d.USE_CASE == "2"){ }}
										<button type="button" class="btn bg-purple btn-xs" lay-event="recharge">催还</button> {{# } }}
										<!-- 如果是未借用状态 -->

										<!-- 如果是借用状态 -->
										{{# if(d.USE_CASE == "2" || d.USE_CASE == "3"){ }}
										<button type="button" class="btn bg-deep-purple btn-xs" lay-event="return">归还</button> {{# } }}
										<!-- 如果是未借用状态 -->

										<!-- 如果是未借用状态 -->
										{{# if(d.USE_CASE == "1"){ }}
										<button type="button" class="btn bg-indigo btn-xs" lay-event="lend">借用</button> {{# } }}
										<!-- 如果是未借用状态 -->

										<button type="button" class="btn btn-raised btn-info btn-xs" style="display: none;">预览</button>
										<button type="button" class="btn btn-raised btn-primary btn-xs" style="display: none;">下载</button>
									</script>
								</div>
							</div>
						</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/adm/cert/list.js"></script>
