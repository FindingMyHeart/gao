...
<html>
	...
	<body class="theme-black">
		...
		<section class="content-modals" id="category_entry_body">
				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card">
							...
							<div class="body">
								<!-- 客户表的主键ID -->
								<input type="hidden" id="TYPE_ID" value="${pd.TYPE_ID}" v-model="TYPE_ID">
								<!-- 类型 -->
								<input type="hidden" id="type" value="${pd.type}" v-model="type">
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="分类编号" type="text" id="C_TYPE_CODE" v-model="C_TYPE_CODE">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="分类名称" type="text" id="C_TYPE_NAME" v-model="C_TYPE_NAME">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="C_PID" v-model="C_PID">
		...
		<!-- js -->
		<script type="text/javascript" src="static/js/modules/material/category_entry.js"></script>
	</body>
