...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">项目录入</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="body">
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control z-index show-tick" data-live-search="true" id="PROJECT_NAME_SEARCH">
									...
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<select class="form-control show-tick" id="MANAGER_USERID_SEARCH">
						...
						<div class="card">
							...
							<div class="body">
								<div class="table-responsive">
									<table class="layui-hide table table-striped" id="afterSaleProject" lay-filter="afterSaleProject"></table>
									<script type="text/html" id="barDemo">
										...
										<button class="btn btn-primary btn-xs">下载</button>
									</script>
								</div>
							</div>
						</div>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/afterSale/xmgl/list.js"></script>
