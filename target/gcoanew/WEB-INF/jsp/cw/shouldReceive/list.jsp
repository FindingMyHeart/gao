...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
					...
					<div class="row">
						<div class="col-lg-5 col-md-5 col-sm-12">
							...
							<ul class="breadcrumb padding-0">
								...
								<li class="breadcrumb-item active">往来管理</li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="body">
								<div class="table-responsive">
									...
									<script type="text/html" id="barDemo">
										<!--财务显示-->
										<button type="button" class="btn bg-red btn-xs" lay-event="addInfo">添加</button>
										<!--财务显示-->
										<!--申请人显示-->
										{{# if(d.CAIWU_STATUS == "1"){ }}
										<button type="button" class="btn btn-danger btn-xs" lay-event="complete">完成</button>
										{{# } }}
										<!--申请人显示-->
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/cw/shouldReceive/list.js"></script>
