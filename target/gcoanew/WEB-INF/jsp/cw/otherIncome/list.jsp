...
<html class="no-js " lang="utf-8">
	...
	<head>
		...
		<script type="text/javascript">
			...
			function edit(rowData) {
				if(rowData) {
					openBootStrapDialog("", "cw/otherIncome/entry?id=" + rowData.INCOME_ID, "1");
				}
			}

			function info(rowData) {
				//var checkStatus = table.checkStatus('mytable');
				//alert(rowData.INCOME_ID);
				if(rowData) {
					openBootStrapDialog("编辑", "cw/otherIncome/entry?id=" + rowData.INCOME_ID, "1");
				}

			}

			function delit(rowData) {
				myjstools.ajax(true, "POST", "/web/service?METHOD=cwotherincome_delete", {
						INCOME_ID: rowData.INCOME_ID
					},
					function(data) {
						try {
							if(data.success != 1) {
			...
			function add() {
				openBootStrapDialog("添加", "cw/otherIncome/entry", "1");
			}
			...
			function onBeforeLoad() {
				...
				param.JIAOKUAN_PERSON = $("#S_JIAOKUAN_PERSON").val();
				return param;
			}
			...
			function initit() {
				...
				layui.use('table', function() {
					...
					table.render({
						elem: '#dg',
						url: myjstools.wwwroot + '/web/service?METHOD=cwotherincome_list',
						id: 'mytable',
						where: onBeforeLoad(),
						...
						cols: [
							[{
								...
								field: 'JIAOKUAN_DEPTNAME',
								width: 120,
								title: '交款部门'
							}, {
								field: 'JIAOKUAN_PERSON',
								width: 120,
								title: '交款人'
							}, {
								field: 'CREATE_TIME',
	...
	<body class="theme-black">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);">其它收入登记</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="交款人" type="text" id="S_JIAOKUAN_PERSON">
										</div>
									</div>
		...
		<%--<script type="text/javascript" src="static/js/modules/otherIncome/list.js"></script>--%>
