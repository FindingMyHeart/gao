...
<html class="no-js " lang="utf-8">
	...
	<body class="theme-black">
								...
								<ul class="header-dropdown">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											<li>
												<a href="javascript:void(0);" @click="save">客户信息录入</a>
											</li>
										</ul>
									</li>
								</ul>
								...
								<div class="row clearfix">
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="名称" type="text" id="customer_name_condition">
										</div>
									</div>
									<div class="col-md-4 col-lg-2 col-sm-4 col-xs-12 m-b-20">
										<div class="form-group">
											<input class="form-control" placeholder="联系电话" type="text" id="client_tel_condition">
										</div>
									</div>
						...
						<div class="card">
							...
							<div class="body">
								<div class="table-responsive">
									<table class="layui-hide table table-striped" id="customer" lay-filter="customer"></table>
		...
		<!-- Js -->
		<script type="text/javascript" src="static/js/modules/customer/list.js"></script>
